...
var Paginator = /** @class */ (function (_super) {
    ...
    Paginator.prototype.builderStyle = function (pred) {
        var myStyle = this.props.styleNavigate;
        if (pred) {
            if (myStyle) {
        ...
        switch (side) {
            ...
            case mySide.first: {
                if (this.props.first) {
                    ...
                    this.list.push(React.createElement("button", { accessKey: this.props.accessKeyFirst, "data-navigate": 'first', style: this.builderStyle(this.state.CurrentPage <= 1 && this.props.isHidingNavigate), disabled: this.state.CurrentPage <= 1, key: v4(), className: 'bsr-button-navigate', onClick: function (e) {
            ...
            case mySide.previous: {
                if (this.props.previous) {
                    // eslint-disable-next-line jsx-a11y/no-access-key
                    this.list.push(React.createElement("button", { accessKey: this.props.accessKeyPrevious, "data-navigate": 'previous', style: this.builderStyle(this.state.CurrentPage <= 1 && this.props.isHidingNavigate), disabled: this.state.CurrentPage <= 1, key: v4(), className: 'bsr-button-navigate', onClick: function (e) {
            ...
            case mySide.next: {
                if (this.props.next) {
                    // eslint-disable-next-line jsx-a11y/no-access-key
                    this.list.push(React.createElement("button", { accessKey: this.props.accessKeyNext, "data-navigate": 'next', style: this.builderStyle(this.state.CurrentPage === this.pages && this.props.isHidingNavigate), disabled: this.state.CurrentPage === this.pages, key: v4(), className: 'bsr-button-navigate', onClick: function (e) {
                            var value = _this.state.CurrentPage + 1;
            ...
            case mySide.last: {
                if (this.props.last) {
                    // eslint-disable-next-line jsx-a11y/no-access-key
                    this.list.push(React.createElement("button", { accessKey: this.props.accessKeyLast, "data-navigate": 'last', style: this.builderStyle(this.state.CurrentPage === this.pages && this.props.isHidingNavigate), disabled: this.state.CurrentPage === this.pages, key: v4(), className: 'bsr-button-navigate', onClick: function (e) {
